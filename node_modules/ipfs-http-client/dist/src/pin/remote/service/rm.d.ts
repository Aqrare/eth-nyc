 ...
 */
export function createRm(client: import('../../../lib/core').Client): (name: string, options?: (import("ipfs-core-types/dist/src").AbortOptions & import("../../../types").HTTPClientExtraOptions) | undefined) => Promise<void>;

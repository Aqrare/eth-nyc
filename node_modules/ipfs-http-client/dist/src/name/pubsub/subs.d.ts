 ...
 */
export const createSubs: import("../../lib/configure.js").Factory<(options?: (import("ipfs-core-types/dist/src").AbortOptions & import("../../types").HTTPClientExtraOptions) | undefined) => Promise<string[]>>;

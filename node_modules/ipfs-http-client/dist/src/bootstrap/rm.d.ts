 ...
 */
export const createRm: import("../lib/configure.js").Factory<(addr: Multiaddr, options?: (import("ipfs-core-types/dist/src").AbortOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<{
    Peers: Multiaddr[];
}>>;

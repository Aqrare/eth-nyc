export function createSubscribe(options: Options, subsTracker: import('./subscription-tracker').SubscriptionTracker): (topic: string, handler: import("@libp2p/interfaces/dist/src/events").EventHandler<import("@libp2p/interfaces/pubsub").Message>, options?: (import("ipfs-core-types/src/pubsub").SubscribeOptions & import("../types").HTTPClientExtraOptions & {

 ...
 */
export const createAddAll: import("./lib/configure.js").Factory<(source: import("ipfs-core-types/dist/src/utils").ImportCandidateStream, options?: (import("ipfs-core-types/src/root").AddAllOptions & import("ipfs-core-types/dist/src").AbortOptions & import("./types").HTTPClientExtraOptions) | undefined) => AsyncIterable<import("ipfs-core-types/src/root").AddResult>>;

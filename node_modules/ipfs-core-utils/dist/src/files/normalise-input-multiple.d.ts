 ...
 */
export function normaliseInput(input: ImportCandidateStream): AsyncGenerator<import("ipfs-unixfs-importer/types/src/types.js").ImportCandidate, void, undefined>;
